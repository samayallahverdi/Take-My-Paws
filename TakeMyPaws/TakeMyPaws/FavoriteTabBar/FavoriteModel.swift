...
// MARK: - FavoritesPetModel
struct FavoritesPetModel: Codable {
    let idNumber: Int?
    ...
    let imageTwo, imageThree, houseTrained, petFriendly: String?
    let shelterName, shelterRequisitiesAz, dateCreated: String?
    let adopted: Bool?
